...
export const agreementDefinitions: AgreementDefinition[] = [
  ...
  {
    id: 'saec-fme-caldas-novas',
    name: 'SAEC FME Caldas Novas',
    slug: 'SaecFmeCaldasNovas',
    description: 'Fundação municipal com folha separada e margem diferenciada.',
    region: 'GO',
    basePrice: 12,
    unit: 'lead',
    suggestedBatch: 15,
  ...
  {
    id: 'saec-fms-caldas-novas',
    name: 'SAEC FMS Caldas Novas',
    slug: 'SaecFmsCaldasNovas',
    description: 'Saúde municipal de Caldas Novas – público com alto ticket médio.',
    region: 'GO',
    basePrice: 12,
    unit: 'lead',
    suggestedBatch: 15,
  ...
  },
  {
    ...
    name: 'SAEC Comurg',
    slug: 'SaecComurg',
    description: 'Companhia de Urbanização de Goiânia, base com alto volume.',
    region: 'GO',
    basePrice: 12,
    unit: 'lead',
    suggestedBatch: 30,
    tags: ['empresa pública'],
  },
  {
    id: 'saec-prtce',
    name: 'SAEC PR TCE',
    slug: 'SaecPrTce',
    description: 'Tribunal de Contas do Paraná – margem média superior.',
    region: 'PR',
    basePrice: 12,
    unit: 'lead',
    suggestedBatch: 20,
