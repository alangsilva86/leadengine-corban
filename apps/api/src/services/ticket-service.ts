...
import { mergeEnrichmentMetadata } from './tickets/enrichment';
import {
  createWhatsAppSendModule,
  rateKeyForInstance,
  resolveDispatchInstanceId,
  resolveInstanceRateLimit,
  type WhatsAppTransportDependencies,
} from './tickets/whatsapp-send';
...
import { getSalesSimulationFilters } from './sales-service';
import { createSalesOperations } from './tickets/sales-operations';
...
export { getDefaultQueueIdForTenant } from './tickets/whatsapp-send';
