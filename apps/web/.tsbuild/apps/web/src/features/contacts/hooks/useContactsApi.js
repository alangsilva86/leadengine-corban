...
export const useContactDetailsQuery = (contactId, { enabled = true } = {}) => useQuery({
...
export const useContactTimelineQuery = (contactId, { enabled = true } = {}) => useQuery({
...
export const useContactTasksQuery = (contactId, { enabled = true } = {}) => useQuery({
