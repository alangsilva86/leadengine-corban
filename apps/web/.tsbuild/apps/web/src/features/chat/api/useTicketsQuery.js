...
const buildQueryString = ({ limit, includeMetrics, include, filters, sortBy = 'lastMessageAt', sortOrder = 'desc', }) => {
...
export const useTicketsQuery = ({ filters = {}, limit = 40, includeMetrics = true, enabled = true, staleTime = 5000, sortBy = 'lastMessageAt', sortOrder = 'desc', } = {}) => {
