...
const normalizeInstance = (instance) => {
    ...
    const slug = typeof instance.slug === 'string' && instance.slug.trim().length > 0
        ? instance.slug.trim()
        : typeof instance.instanceId === 'string'
            ? instance.instanceId.trim()
            : instance.id;
    const color = typeof instance.color === 'string' && instance.color.trim().length > 0
        ? instance.color.trim()
        : instance.uiColor ?? null;
    const phoneCandidate = instance.phone ??
