import { BadgeCheck, CircleDollarSign, ClipboardList, Clock3, FileCheck2, FileSignature, FileText, HelpCircle, Hourglass, Link2, RefreshCcw, Sparkles, } from 'lucide-react';
...
const formatFallbackStageLabel = (stageKey) => stageKey
    .split('_')
    .filter(Boolean)
...
const getTicketStage = (ticket) => {
    const stage = ticket?.pipelineStep ??
...
export { STAGE_LABELS, STAGE_PRESENTATION, STAGE_VALUE_MAP, PRIMARY_ACTION_PRESETS, PRIMARY_ACTION_MAP, STAGE_SALES_HINTS, SALES_STAGE_ORDER, normalizeStage, formatStageLabel, getTicketStage, getStageInfo, resolvePrimaryAction, getStageSalesHints, applyStageSalesHints, getSalesStageOrder, };
