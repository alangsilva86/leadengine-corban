...
describe('Conversation actions anchors', () => {
    ...
    it('mantém IDs únicos e permite navegação pelo QuickActionsBar', async () => {
        ...
        render(_jsx(ConversationHeader, { ticket: ticket, typingAgents: [], onAssign: vi.fn(), onScheduleFollowUp: vi.fn(), onRegisterResult: vi.fn(), onRegisterCallResult: vi.fn(), onSendTemplate: vi.fn(), onCreateNextStep: vi.fn(), onGenerateProposal: vi.fn() }));
    ...
    it('expande e foca o editor de próximo passo ao executar a ação de qualificação', async () => {
        ...
        render(_jsx(ConversationHeader, { ticket: ticket, typingAgents: [], onAssign: vi.fn(), onScheduleFollowUp: onScheduleFollowUp, onRegisterResult: vi.fn(), onRegisterCallResult: vi.fn(), onSendTemplate: vi.fn(), onCreateNextStep: vi.fn(), onGenerateProposal: vi.fn(), onAttachFile: vi.fn(), onFocusComposer: onFocusComposer, nextStepValue: "", onNextStepSave: vi.fn() }));
    ...
    it('abre o seletor de atribuição e envia o userId escolhido', async () => {
        ...
        render(_jsx(ConversationHeader, { ticket: ticket, typingAgents: [], onAssign: onAssign, onScheduleFollowUp: vi.fn(), onRegisterResult: vi.fn(), onRegisterCallResult: vi.fn(), onSendTemplate: vi.fn(), onCreateNextStep: vi.fn(), onGenerateProposal: vi.fn() }));
        const assignButton = screen.getByRole('button', { name: /Atribuir/i });
