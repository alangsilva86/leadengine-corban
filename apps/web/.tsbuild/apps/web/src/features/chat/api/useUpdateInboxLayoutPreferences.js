...
import { DEFAULT_INBOX_LAYOUT_PREFERENCES, INBOX_LAYOUT_PREFERENCES_QUERY_KEY, MIN_INBOX_LIST_WIDTH, MAX_INBOX_LIST_WIDTH, } from './useInboxLayoutPreferences.js';
    ...
    return useMutation({
        ...
        onMutate: async (partial) => {
            ...
            queryClient.setQueryData(INBOX_LAYOUT_PREFERENCES_QUERY_KEY, (current) => {
                ...
                const nextWidth = clampWidth(Number(partial?.inboxListWidth)) ?? rest?.inboxListWidth ?? DEFAULT_INBOX_LAYOUT_PREFERENCES.inboxListWidth;
                return {
