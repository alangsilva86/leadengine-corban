...
describe('FilterToolbar', () => {
    ...
    it('exibe o botão circular com ícone de WhatsApp para iniciar conversa manual', async () => {
        ...
        render(_jsx(FilterToolbar, { ...defaultProps, onStartManualConversation: onStartManualConversation, manualConversationPending: false }));
    ...
    it('exibe aviso quando a conversa manual está indisponível', () => {
        ...
        render(_jsx(FilterToolbar, { ...defaultProps, manualConversationUnavailableReason: reason }));
