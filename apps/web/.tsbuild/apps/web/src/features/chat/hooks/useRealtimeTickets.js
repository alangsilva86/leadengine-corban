...
export const useRealtimeTickets = ({ tenantId, userId, ticketId, enabled = true, onTicketEvent, onTicketUpdated, onMessageCreated, onMessageUpdated, onMessageStatusChanged, onTyping, onQueueMissing, } = {}) => {
        ...
        const connect = async () => {
            try {
                ...
                const handleMessageUpdated = (payload) => {
                    ...
                    const updatedAt = payload?.message?.updatedAt ?? payload?.updatedAt ?? payload?.message?.statusUpdatedAt ?? null;
