...
export const normalizeCrmFilters = (filters) => {
    const normalized = {
        ...
        inactivityDays: typeof filters.inactivityDays === 'number' && filters.inactivityDays >= 0 ? filters.inactivityDays : null,
        score: normalizeScoreRange(filters.score),
        dateRange: normalizeDateRange(filters.dateRange),
    };
    return normalized;
};
export const serializeCrmFilters = (filters) => {
