...
const defaultFilters = normalizeCrmFilters({
...
export const CrmStoryProviders = ({ children }) => {
    useMockFetch();
    const filters = useMemo(() => defaultFilters, []);
    return (_jsx(QueryClientProvider, { client: queryClient, children: _jsx(CrmViewProvider, { filters: filters, children: children }) }));
};
