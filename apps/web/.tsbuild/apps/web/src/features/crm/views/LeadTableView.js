...
const LeadTableView = () => {
    ...
    return (_jsx(LeadTable, { leads: leads, selectedIds: selectedIds, onToggleSelect: handleToggleSelect, onOpenDrawer: handleOpenDrawer, fetchNextPage: fetchNextPage, hasNextPage: hasNextPage, isFetchingNextPage: isFetchingNextPage, isLoading: isLoading, selectable: permissions.canMoveLead }));
};
