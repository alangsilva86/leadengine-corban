...
import type { NormalizedInstance, ParsedInstancesPayload, SelectInstanceOptions } from '../../lib/instances';
...
export interface InstancesSlice {
    ...
    requestLoad(options?: InstancesLoadOptions, meta?: {
        silent?: boolean;
    }): number;
    applyLoadResult(payload: ParsedInstancesPayload, meta: {
        requestId: number;
        preferredInstanceId?: Nullable<string>;
        campaignInstanceId?: Nullable<string>;
        forced?: boolean;
    ...
    selectInstance(id: string | null, options?: {
        skipAutoQr?: boolean;
    }): void;
