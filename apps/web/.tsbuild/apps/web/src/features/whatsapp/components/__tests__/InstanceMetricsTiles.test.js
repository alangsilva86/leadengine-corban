...
describe('InstanceMetricsTiles', () => {
    it('exibe métricas e informações de uso de limite', () => {
        render(_jsx(InstanceMetricsTiles, { surfaceStyles: surfaceStyles, metrics: { sent: 15, queued: 5, failed: 2, status: { 1: 10, 2: 5 }, rateUsage: { used: 20, remaining: 30, limit: 50, percentage: 40 } }, statusValues: { 1: 10, 2: 5 }, statusCodeMeta: statusCodeMeta, rateUsage: { used: 20, remaining: 30, limit: 50, percentage: 40 }, ratePercentage: 40 }));
