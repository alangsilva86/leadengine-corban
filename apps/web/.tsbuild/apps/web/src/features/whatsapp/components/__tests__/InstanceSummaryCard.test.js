...
describe('InstanceSummaryCard', () => {
    it('exibe informações da instância e permite ações', async () => {
        ...
        render(_jsx(InstanceSummaryCard, { surfaceStyles: surfaceStyles, statusCodeMeta: statusCodeMeta, isBusy: false, isAuthenticated: true, deletingInstanceId: null, onSelectInstance: onSelectInstance, onViewQr: onViewQr, onRequestDelete: onRequestDelete, viewModel: {
                key: 'instance-1',
                id: 'instance-1',
    ...
    it('diferencia estado de reconexão do estado desconectado', () => {
        render(_jsx(InstanceSummaryCard, { surfaceStyles: surfaceStyles, statusCodeMeta: statusCodeMeta, isBusy: false, isAuthenticated: true, deletingInstanceId: null, onSelectInstance: vi.fn(), onViewQr: vi.fn(), onRequestDelete: vi.fn(), viewModel: {
                key: 'instance-2',
                id: 'instance-2',
