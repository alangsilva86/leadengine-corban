...
export const findCampaignProduct = (value) => WHATSAPP_CAMPAIGN_PRODUCTS.find((option) => option.value === value) ?? null;
export const findCampaignStrategy = (value) => WHATSAPP_CAMPAIGN_STRATEGIES.find((option) => option.value === value) ?? null;
