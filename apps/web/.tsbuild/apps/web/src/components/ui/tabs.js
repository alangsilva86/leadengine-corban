...
function TabsList({ className, ...props }) {
    return (_jsx(TabsPrimitive.List, { "data-slot": "tabs-list", className: cn("bg-muted text-muted-foreground flex min-w-0 h-9 items-center justify-start rounded-lg p-[3px]", className), ...props }));
}
