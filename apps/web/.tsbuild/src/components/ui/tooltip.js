...
function TooltipProvider({ delayDuration = 0, skipDelayDuration = 300, ...props }) {
...
function Tooltip({ delayDuration, skipDelayDuration, ...props }) {
    return (_jsx(TooltipProvider, { delayDuration: delayDuration, skipDelayDuration: skipDelayDuration, children: _jsx(TooltipPrimitive.Root, { "data-slot": "tooltip", ...props }) }));
}
