...
function readSidebarCookie(defaultValue) {
...
function SidebarProvider({ defaultOpen = true, open: openProp, onOpenChange: setOpenProp, className, style, children, ...props }) {
    ...
    React.useEffect(() => {
        if (setOpenProp)
            return;
        const storedValue = readSidebarCookie(defaultOpen);
    ...
    return (_jsx(SidebarContext.Provider, { value: contextValue, children: _jsx(TooltipProvider, { delayDuration: 0, children: _jsx("div", { "data-slot": "sidebar-wrapper", style: {
                    ...
                    ...style
                }, className: cn("group/sidebar-wrapper has-data-[variant=inset]:bg-sidebar flex min-h-svh h-svh h-screen w-full overflow-hidden", className), ...props, children: children }) }) }));
}
