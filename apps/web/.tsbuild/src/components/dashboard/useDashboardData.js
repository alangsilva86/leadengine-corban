...
import { buildDashboardMetrics, deriveTrend, formatNumberValue, formatPercentValue, } from './dashboard.metrics';
export const useDashboardData = () => {
    ...
    const metrics = useMemo(() => buildDashboardMetrics(ticketsQuery.data, leadsQuery.data, leadMetricsQuery.data), [ticketsQuery.data, leadsQuery.data, leadMetricsQuery.data]);
    const stats = useMemo(() => {
    ...
    const errorMessages = useMemo(() => [
        ...
        leadMetricsQuery.error instanceof Error
            ...
            : null,
    ].filter((message) => Boolean(message)), [ticketsQuery.error, leadsQuery.error, leadMetricsQuery.error]);
    const loading = {
