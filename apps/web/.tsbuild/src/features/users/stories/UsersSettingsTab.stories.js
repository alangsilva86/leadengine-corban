...
const Providers = ({ children }) => {
    ...
    return (_jsx(QueryClientProvider, { client: queryClient, children: _jsx(AuthProvider, { children: _jsx("div", { className: "p-6", children: children }) }) }));
};
export default {
...
export const Default = {
    render: () => (_jsx(Providers, { children: _jsx(UsersSettingsTab, {}) })),
};
