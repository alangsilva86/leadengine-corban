...
export const ListView = () => (_jsx(QueryClientProvider, { client: queryClient, children: _jsx(MemoryRouter, { children: _jsx(MockedContactsPage, {}) }) }));
export const SummaryCard = () => (_jsx("div", { className: "max-w-4xl p-6", children: _jsx(ContactSummary, { contact: {
            name: 'Alice Doe',
            phone: '+55 11 99999-0000',
            email: 'alice@example.com',
