...
describe('ChatCommandCenter WhatsApp integration errors', () => {
    ...
    it('locks the composer and shows WhatsApp configuration guidance on broker errors', async () => {
        ...
        render(_jsx(ChatCommandCenter, { tenantId: "tenant-x", currentUser: { id: 'agent-1' } }));
        ...
        await waitFor(() => {
            expect(toast.error).toHaveBeenCalledWith('WhatsApp não configurado', expect.objectContaining({
