...
describe('ConversationHeader', () => {
    it('renders without crashing for basic ticket', () => {
        ...
        const { getByText } = render(_jsx(ConversationHeader, { ticket: ticket, onRegisterResult: () => { }, onRegisterCallResult: () => { }, onAssign: () => { }, onSendTemplate: () => { }, onCreateNextStep: () => { }, onGenerateProposal: () => { }, onScheduleFollowUp: () => { }, onAttachFile: () => { } }));
