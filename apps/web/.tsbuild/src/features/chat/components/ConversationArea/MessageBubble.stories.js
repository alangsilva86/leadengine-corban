...
export default {
    ...
    render: (args) => (_jsx("div", { className: "min-h-screen w-full bg-slate-900 p-8", children: _jsx("div", { className: "mx-auto flex max-w-2xl justify-center", children: _jsx(MessageBubble, { ...args }) }) })),
};
