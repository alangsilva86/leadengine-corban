...
export const useAiReplyStream = () => {
    ...
    const updateState = useCallback((updater) => {
        const nextState = typeof updater === 'function' ? updater(committedStateRef.current) : updater;
    ...
    const start = useCallback(async ({ conversationId, timeline, metadata = {}, mode = DEFAULT_AI_MODE }) => {
        if (!conversationId) {
