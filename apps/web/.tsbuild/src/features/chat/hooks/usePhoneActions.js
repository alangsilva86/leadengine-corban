...
export function usePhoneActions(rawPhone, options = {}) {
    const { onCall, missingPhoneMessage = 'Nenhum telefone disponível para este contato.', copySuccessMessage = 'Telefone copiado.', } = options;
    return useCallback((action, overridePhone) => {
