...
export const normalizeTextValue = (value) => normalizeString(value);
...
const contactFieldValueSchemas = {
    name: trimmedStringSchema,
    document: trimmedStringSchema,
    email: trimmedStringSchema,
    phone: phoneSchema,
};
const dealFieldValueSchemas = {
...
export const normalizeContactFieldValue = (field, value) => {
    return contactFieldValueSchemas[field].parse(value);
};
export const normalizeDealFieldValue = (field, value) => {
