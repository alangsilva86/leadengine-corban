...
vi.mock('../components/CreateInstanceDialog.jsx', () => ({
    __esModule: true,
    default: ({ open }) => (open ? _jsx("div", { "data-testid": "create-instance-dialog", children: "Criar inst\u00E2ncia" }) : null),
}));
vi.mock('../components/QrPreview', () => ({
    __esModule: true,
    default: () => _jsx("div", { "data-testid": "qr-preview", children: "QR Preview" }),
}));
vi.mock('../components/AdvancedOperationsPanel.jsx', () => ({
    __esModule: true,
    default: () => _jsx("div", { "data-testid": "advanced-ops", children: "Advanced Ops" }),
}));
describe('WhatsAppConnect', () => {
    ...
    it('renders the instances overview and triggers actions', async () => {
        render(_jsx(Suspense, { fallback: _jsx("span", { children: "loading" }), children: _jsx(WhatsAppConnect, {}) }));
