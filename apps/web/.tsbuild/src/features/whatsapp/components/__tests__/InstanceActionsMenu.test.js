...
describe('InstanceActionsMenu', () => {
    it('habilita ações para visualizar QR e remover instância', async () => {
        ...
        render(_jsx(InstanceActionsMenu, { instance: { id: 'instance-1' }, deletingInstanceId: null, isBusy: false, isAuthenticated: true, onViewQr: onViewQr, onRequestDelete: onRequestDelete }));
    ...
    it('desabilita ações quando instância está sendo removida', () => {
        render(_jsx(InstanceActionsMenu, { instance: { id: 'instance-2' }, deletingInstanceId: "instance-2", isBusy: false, isAuthenticated: true }));
