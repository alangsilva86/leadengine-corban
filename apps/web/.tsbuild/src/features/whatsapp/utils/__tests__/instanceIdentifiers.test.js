...
import { extractInstanceFromPayload, looksLikeWhatsAppJid, resolveInstancePhone, } from '../../lib/instances';
describe('WhatsApp instance identifier helpers', () => {
    ...
    describe('resolveInstancePhone', () => {
        it('prefers explicit phone number fields', () => {
            ...
            expect(resolveInstancePhone({ metadata: { phoneNumber: '+5511777777777' } })).toBe('+5511777777777');
        });
        it('falls back to broker identifiers and empty string', () => {
            expect(resolveInstancePhone({ metadata: { phone_number: '+5511666666666' } })).toBe('+5511666666666');
            expect(resolveInstancePhone({ jid: '5511555555555@s.whatsapp.net' })).toBe('5511555555555@s.whatsapp.net');
