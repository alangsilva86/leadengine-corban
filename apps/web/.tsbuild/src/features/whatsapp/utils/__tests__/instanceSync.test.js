...
import { buildTimelineEntries, deriveStatusFromSources, reduceRealtimeEvents, reconcileInstancesState, resolveFriendlyError, selectPreferredInstance, } from '../instanceSync';
...
describe('instanceSync utils', () => {
    ...
    describe('deriveStatusFromSources', () => {
        it('prefers explicit status over connected flag', () => {
            expect(deriveStatusFromSources({ explicitStatus: 'connecting', explicitConnected: true })).toBe('connecting');
        });
    });
});
