...
export const normalizeWindow = (window: AgreementWindowDto): AgreementWindow => {
...
export const normalizeRate = (rate: AgreementRateDto): AgreementRate => {
...
export const normalizeHistoryEntry = (entry: AgreementHistoryEntryDto): AgreementHistoryEntry => ({
  id: entry.id,
...
export const normalizeAgreement = (agreement: AgreementDto): Agreement => {
...
export const normalizeAgreementsCollection = (
  agreements: AgreementDto[] | undefined | null
): Agreement[] => (Array.isArray(agreements) ? agreements.map(normalizeAgreement) : []);
