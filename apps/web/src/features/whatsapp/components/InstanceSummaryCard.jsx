...
const InstanceSummaryCard = ({
  ...
  const primaryActionLabel = connectionState === 'connected' ? 'Manter saudável' : 'Gerar QR Code';
    ...
    >
      <div className="flex items-start justify-between gap-3">
        <div className="space-y-1">
          ...
          {addressLabel ? <p className="text-[0.65rem] text-muted-foreground/80">{addressLabel}</p> : null}
        </div>
