...
const LeadConversationPanel = ({ allocation, onOpenWhatsApp, isLoading, isSwitching }) => {
  ...
  return (
    <div className="flex min-h-[520px] flex-col rounded-[32px] border border-surface-contrast bg-slate-950/50 shadow-[0_30px_64px_-42px_rgba(15,23,42,0.9)] ring-1 ring-white/10 backdrop-blur-xl xl:h-full">
