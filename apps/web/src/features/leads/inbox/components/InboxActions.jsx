    ...
    <div className="space-y-4">
      <Card className="rounded-3xl border-surface-contrast bg-white/[0.08] shadow-[0_18px_40px_rgba(5,12,30,0.45)]">
        ...
        <CardContent className="space-y-4 text-xs">
          <div className="flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-surface-contrast bg-white/[0.08] px-4 py-3 text-white/75 shadow-[0_14px_32px_rgba(5,12,28,0.35)]">
