    ...
    <div className="rounded-xl border border-slate-800/60 bg-slate-950/70 p-3">
      <div className="grid grid-cols-2 gap-3">
        <div className="space-y-1">
          <span className="text-xs font-medium uppercase tracking-[0.18em] text-muted-foreground/70">FRT &lt; 5 min</span>
        ...
        <div className="space-y-1">
          <span className="text-xs font-medium uppercase tracking-[0.18em] text-muted-foreground/70">Entropia status</span>
          <p className="text-base font-bold text-foreground">
            {metrics.statusEntropy ?? '—'}
          </p>
        </div>
        <div className="space-y-1">
          <span className="text-xs font-medium uppercase tracking-[0.18em] text-muted-foreground/70">Proposta → CCB</span>
          <p className="text-base font-bold text-foreground">
        ...
        <div className="space-y-1">
          <span className="text-xs font-medium uppercase tracking-[0.18em] text-muted-foreground/70">Qualidade WA</span>
          <p className="text-base font-bold text-foreground">
      ...
      <div className="chat-scroll-area flex-1 overflow-y-auto pr-1">
        {tickets.length === 0 ? (
          <div className="flex h-full flex-col items-center justify-center rounded-xl border border-dashed border-slate-800/70 bg-slate-950/70 p-6 text-center text-[13px] text-muted-foreground/80">
            ...
            <p className="text-xs font-medium text-muted-foreground/70">Ajuste os filtros ou pesquise por outro contato.</p>
          </div>
        ) : (
