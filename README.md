...
> **Suporte:** Se o console do navegador exibir erros de CORS ao acessar a API hospedada, siga o passo a passo em [`docs/qa/cors-troubleshooting.md`](docs/qa/cors-troubleshooting.md).
